jQuery(document).ready(function(){
    ...
    /*
     * Schedular applicatoion jsvascript
     * Author @jashanpreet Singh
     */

    jQuery('.dropdown-menu a').on('click', function(){
        jQuery(this).parent().parent().prev().html($(this).html() + '<span style="margin-left: 3px;" class="caret"></span>');
    })
    ...
    jQuery(function() {
        jQuery( ".datepickerCalender" ).datepicker({
            inline: true,
